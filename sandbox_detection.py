...
# Could easily do with PyHook but its good to have a few different methods
def get_key_press():
...
def detect_sandbox():
    ...
    # If we hit our threshold, lets bail
    ...
    while not detection_complete:
        ...
        if keypress_time is not None and previous_timestamp is not None:
            ...
            # we are happy there is enough user input
